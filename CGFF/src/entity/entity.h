...
namespace CGFF {
    ...
    public:
        Entity();
		Entity(const QSharedPointer<Mesh>& mesh, const QMatrix4x4& transform = QMatrix4x4());
		Entity(const QSharedPointer<Sprite>& sprite, const QMatrix4x4& transform = QMatrix4x4());
